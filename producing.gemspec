...
require_relative "lib/producing/version"

Gem::Specification.new do |spec|
  spec.name = "producing"
  spec.version = Producing::VERSION
  spec.authors = ["Richard LeBer"]
  spec.email = ["richard.leber@gmail.com"]

  spec.summary = "Check: Are we in production?"
  ...
  DESCRIPTION
  spec.homepage = "https://github.com/rleber/producing"
  spec.license = "MIT"
